...
import cn.com.cretech.databinding.ItemChildDynamicMicroBinding
...
class ChildDynamicMicroAdapter(
    context : Context, var list: MutableList<ChildMicroPublishedBean.DataBean.SchoolDynamic> ) : BaseListAdapter<ChildMicroPublishedBean.DataBean.SchoolDynamic, ItemChildDynamicMicroBinding>(context, list) {
    override fun setRes(): Int {
        return R.layout.item_child_dynamic_micro
    }
