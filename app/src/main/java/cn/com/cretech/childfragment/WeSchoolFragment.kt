...
import cn.com.cretech.presenter.WeSchoolPresenter
import cn.com.cretech.setting.NetWorkResult
import com.tmall.ultraviewpager.UltraViewPager
import retrofit2.Response

class WeSchoolFragment : MVPBaseFragment<WeSchoolPresenter, FragmentChildMicroBinding>() ,
    ...
    override fun initView() {
        super.initView()
        presenter = WeSchoolPresenter(this,context!!,childFragmentManager)
    }
